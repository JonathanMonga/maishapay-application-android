...
import com.maishapay.presenter.RegisterNormalPresenter;
...
public class RegisterNormalActivity extends TiActivity<RegisterNormalPresenter, RegisterNormalView> implements RegisterNormalView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Créer un compte Maishapay");
    ...
    public void clickCriarConta(){
        ...
        getPresenter().inscription(
                ...
                codePin1EditText.getText().toString().trim());
    }
    ...
    @NonNull
    @Override
    public RegisterNormalPresenter providePresenter() {
        return new RegisterNormalPresenter();
    }
