...
public class DialogForgotFragment extends AppCompatDialogFragment {
    ...
    public static DialogForgotFragment newInstance(String telephone){
        DialogForgotFragment dialogForgotFragment = new DialogForgotFragment();
