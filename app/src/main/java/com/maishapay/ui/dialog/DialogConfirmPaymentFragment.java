...
public class DialogConfirmPaymentFragment extends AppCompatDialogFragment {
    ...
    public static DialogConfirmPaymentFragment newInstance(String prenom, String nom) {
