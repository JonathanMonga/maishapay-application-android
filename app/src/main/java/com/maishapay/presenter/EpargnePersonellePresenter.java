...
public class EpargnePersonellePresenter extends TiPresenter<EpargnePersonelleView> {
    ...
    public void transfertEpargnePersonelle(String type_transfert, String destinataire, String monnaie, String montant){
    ...
    public void confirmTransfertEpargne(String type_transfert_ep, String destinataire, String monnaie, String montant){
