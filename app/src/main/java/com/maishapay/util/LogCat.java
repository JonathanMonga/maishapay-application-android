...
import static com.maishapay.BuildConfig.LOGCAT_TAG;
...
public final class LogCat {
    ...
    public static void e(String message, Throwable cause) {
        Log.e(LOGCAT_TAG, "[" + message + "]", cause);
    }
    ...
    public static void e(String msg) {
        ...
        Log.e(LOGCAT_TAG, "[" + callerClassName + "] " + msg);
    }
    ...
    public static void w(String message, Throwable cause) {
        Log.w(LOGCAT_TAG, "[" + message + "]", cause);
    }
    ...
    public static void w(String msg) {
        ...
        String callerClassName = elements[1].getFileName();
        Log.w(LOGCAT_TAG, "[" + callerClassName + "] " + msg);
    }
    ...
    public static void i(String message, Throwable cause) {
        Log.i(LOGCAT_TAG, "[" + message + "]", cause);
    }
    ...
    public static void i(String msg) {
        ...
        String callerClassName = elements[1].getFileName();
        Log.i(LOGCAT_TAG, "[" + callerClassName + "] " + msg);
    }
    ...
    public static void d(String msg) {
        if (BuildConfig.DEBUG) {
            ...
            String callerClassName = elements[1].getFileName();
            Log.d(LOGCAT_TAG, "[" + callerClassName + "] " + msg);
        }
    }
    ...
    public static void v(String msg) {
        if (BuildConfig.DEBUG) {
            ...
            String callerClassName = elements[1].getFileName();
            Log.v(LOGCAT_TAG, "[" + callerClassName + "] " + msg);
        }
    }
}
